# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
# 37 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
...
void ENET_DRV_TimerGetCapture(uint8_t instance,
                              uint8_t channel,
                              uint32_t *capture);
# 41 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.h" 2
...
# 38 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c" 2
...
# 76 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
static void ENET_SetTxBufferDescriptors(const enet_config_t *config,
                                        enet_buffer_descriptor_t *txBdStartAlign,
                                        uint32_t txRingSize)
{
...
# 176 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
void ENET_ConfigBufferDescriptors(ENET_Type * base,
                                  const enet_config_t *config,
                                  const enet_buffer_config_t *bufferConfig,
                                  uint16_t buffSize)
                               ...
                               const enet_config_t *config)
{
    ...
    rcr = (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_ENABLE_PAYLOAD_LEN_CHECK) != 0UL) ? 1UL : 0UL))<<30u))&0x40000000u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_ENABLE_FLOW_CONTROL) != 0UL) ? 1UL : 0UL))<<15u))&0x8000u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_STRIP_CRC_FIELD) != 0UL) ? 1UL : 0UL))<<14u))&0x4000u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_ENABLE_FLOW_CONTROL) != 0UL) ? 1UL : 0UL))<<5u))&0x20u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_FORWARD_PAUSE_FRAMES) != 0UL) ? 1UL : 0UL))<<13u))&0x2000u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_REMOVE_PADDING) != 0UL) ? 1UL : 0UL))<<12u))&0x1000u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_REJECT_BROADCAST_FRAMES) != 0UL) ? 1UL : 0UL))<<4u))&0x10u) |
          (((uint32_t)(((uint32_t)(((config->rxConfig & (uint32_t)ENET_RX_CONFIG_ENABLE_PROMISCUOUS_MODE) != 0UL) ? 1UL : 0UL))<<3u))&0x8u) |
          (((uint32_t)(((uint32_t)(1U))<<2u))&0x4u) |
          (((uint32_t)(((uint32_t)(config->miiMode))<<8u))&0x100u) |
          (((uint32_t)(((uint32_t)(config->miiSpeed))<<9u))&0x200u) |
          (((uint32_t)(((uint32_t)(config->maxFrameLen))<<16u))&0x3FFF0000u);


    if (config->miiDuplex == ENET_MII_HALF_DUPLEX)
    {
        rcr |= (((uint32_t)(((uint32_t)(1))<<1u))&0x2u);
    }

    if ((config->rxConfig & (uint32_t)ENET_RX_CONFIG_ENABLE_MII_LOOPBACK) != 0U)
    {
        rcr |= (((uint32_t)(((uint32_t)(1))<<0u))&0x1u);
        rcr &= ~0x2u;
    }
    base->RCR = rcr;
}
                                ...
                                const enet_config_t *config)
{
    ...
    tcr &= ~(0x4u | 0x200u | 0x100u);
    tcr |= (((uint32_t)(((uint32_t)(config->miiDuplex))<<2u))&0x4u) |
           (((uint32_t)(((uint32_t)(((config->txConfig & (uint32_t)ENET_TX_CONFIG_DISABLE_CRC_APPEND) != 0UL) ? 1UL : 0UL))<<9u))&0x200u) |
           (((uint32_t)(((uint32_t)(((config->txConfig & (uint32_t)ENET_TX_CONFIG_ENABLE_MAC_ADDR_INSERTION) != 0UL) ? 1UL : 0UL))<<8u))&0x100u);

    base->TCR = tcr;
}
# 262 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
void ENET_TransmitIRQHandler(uint8_t instance)
{
    ...
    if ((((uint32_t)ENET_TX_BUFFER_INTERRUPT | (uint32_t)ENET_TX_FRAME_INTERRUPT) & base->EIR) != 0U)
    {
        ...
        if (g_enetState[instance]->callback != ((void *)0))
        {
            g_enetState[instance]->callback(instance, ENET_TX_EVENT);
        }
    }
}
# 288 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
void ENET_ReceiveIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
...
# 314 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
void ENET_ErrorIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
...
# 342 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
void ENET_WakeIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];
    ...
    if (((uint32_t)ENET_WAKEUP_INTERRUPT & base->EIR) != 0U)
    {
        ...
        ENET_DRV_SetSleepMode(instance, 0);
...
# 369 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/platform/drivers/src/enet/enet_hw_access.c"
void ENET_TimerIRQHandler(uint8_t instance)
{
    ENET_Type *base = s_enetBases[instance];

    if ((base->EIR & 0x8000u) != 0U)
    {
        if (g_enetState[instance]->timerCallback != ((void *)0))
        {
            g_enetState[instance]->timerCallback(instance, (uint8_t)base->TGSR);
        }


        base->EIR = (uint32_t)0x8000u;
    }
}
